...
const uiTranslations = {
  ...
  giftCopy: ['If you would like to give something, a contribution toward our future would be deeply appreciated. Canadian guests may send an e-transfer to valeriaandseanharrigan@gmail.com. We kindly ask for electronic transfers only, rather than cash. Thank you.', 'Si deseas hacer un regalo, una contribución para nuestro futuro será muy apreciada. Para nuestros invitados en México será por transferencia electrónica; compartiremos los datos más cerca de la fecha. Te pedimos que sea únicamente por transferencia, no en efectivo. ¡Gracias!'],
...
const phraseTranslations = new Map(Object.entries({
  ...
  'Gracias':'Gracias','We cannot wait to celebrate together.':'No podemos esperar para celebrar juntos.','Until we say I do':'Hasta el gran día','Days':'Días','Hours':'Horas','Minutes':'Minutos','Seconds':'Segundos'
}));
...
if (matchMedia('(hover: hover) and (pointer: fine)').matches) {
  document.querySelectorAll('.practical .accordion-trigger, .faq .accordion-trigger').forEach((trigger) => {
