...
const uiTranslations = {
  ...
  travelAccommodationMore: ['Pricing per night is $2,250 MXN for 2 guests (approximately $180 CAD). For double suites, a 3rd and 4th guest are an additional $850 MXN per person. Tepoztlán is also home to many wonderful nearby boutique hotels.', 'La tarifa por noche es de $2,250 MXN para 2 huéspedes. En suites dobles, el tercer y cuarto huésped tienen un costo adicional de $850 MXN por persona. Tepoztlán también cuenta con excelentes hoteles boutique cercanos.'],
  ...
  travelTransportCity: ['<strong>Mexico City to Tepoztlán</strong><br>Tepoztlán is approximately a 1.5-hour drive from the city and can be reached by private transfer, taxi, rideshare or car rental.', '<strong>CDMX a Tepoztlán</strong><br>Tepoztlán se encuentra aproximadamente a una hora y media de la Ciudad y se puede llegar en traslado privado, taxi, transporte por aplicación o auto rentado.'],
  travelTransportLocal: ['<strong>Tepoztlán to venue</strong><br>The town and nearby accommodation are close to the venue. Taxis and rideshare services are the simplest local options.', '<strong>Tepoztlán al recinto</strong><br>El pueblo y los alojamientos cercanos están a poca distancia del recinto. Los taxis y transportes por aplicación son las opciones locales más sencillas.'],
  ...
  travelWeatherCopy: ['November in Tepoztlán is generally dry and comfortable, with warm afternoons and noticeably cooler evenings. Bring a light layer for after sunset.<br><strong>Typical daytime highs: 24–27°C &nbsp; Nights: 10–13°C</strong>', 'Noviembre en Tepoztlán suele ser seco y agradable, con tardes cálidas y noches notablemente más frescas. Lleva una capa ligera para después del atardecer.<br><strong>Máximas habituales: 24–27°C &nbsp; Noches: 10–13°C</strong>'],
