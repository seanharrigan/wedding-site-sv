...
const uiTranslations = {
  ...
  introKicker: ['The Wedding Of', 'La boda de'], openEnvelope: ['Click to open', 'Haz clic para abrir'], openInvitation: ['Open invitation', 'Abrir invitación'], closeInvitation: ['Close invitation', 'Cerrar invitación'], inviteEyebrow: ['With joy', 'Con alegría'], inviteFamily: ['Together with their families', 'Con sus familias'], inviteCopy: ['request the pleasure of your company as they celebrate their marriage.', 'tienen el gusto de invitarlos a celebrar su matrimonio.'], inviteVenue: ['Hotel Piedra Viva<br>Tepoztlán, Morelos · México', 'Hotel Piedra Viva<br>Tepoztlán, Morelos · México'], enterSite: ['Enter our celebration <span aria-hidden="true">→</span>', 'Entrar al sitio <span aria-hidden="true">→</span>'], viewInvitation: ['Invitation', 'Invitación'], skipToContent: ['Skip to content', 'Ir al contenido'], partyPlaceholder: ['Names of everyone in your party', 'Nombres de todos los asistentes'],
  ...
  specialEyebrow: ['A special request', 'Una petición especial'], specialTitle: ['<span>For those who<br>remain in</span> <em>Spirit</em>.', '<span>Para quienes siguen<br>con nosotros en</span> <em>espíritu</em>.'], giftsEyebrow: ['Gifts', 'Regalos'], giftsTitle: ['<span>Your presence<br>is our</span> <em>gift</em>.', '<span>Su presencia<br>es nuestro mejor</span> <em>regalo</em>.'], contactUs: ['Contact us', 'Escríbannos'],
  weekKicker: ['For those travelling afar', 'Para quienes vienen de lejos'], weekTitle: ['A week<br>in <em>Mexico</em>.', 'Una semana<br>en <em>México</em>.'], weekBrief: ['Arrive early, stay a little longer, and make the celebration part of a beautiful week away.', 'Lleguen antes, quédense unos días y disfruten una semana completa en México.'],
